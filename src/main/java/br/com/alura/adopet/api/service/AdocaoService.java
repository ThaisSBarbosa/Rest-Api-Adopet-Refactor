...
public class AdocaoService {
	...
	public void solicitar(DadosSolicitacaoAdocao dto) {
...
//		emailService.enviarEmail(tutor.getEmail(), "Solicitação de adoção",
//				"Olá " + tutor.getNome() + "!\n\nUma solicitação de adoção foi registrada hoje para o pet: "
//						+ pet.getNome() + ". \nFavor avaliar para aprovação ou reprovação.");
	}

	public void aprovar(DadosAprovacaoAdocao dto) {
...
//						+ adocao.getPet().getAbrigo().getNome() + " para agendar a busca do seu pet.");
	...
	public void reprovar(DadosReprovacaoAdocao dto) {
		Adocao adocao = repository.getReferenceById(dto.idAdocao());
